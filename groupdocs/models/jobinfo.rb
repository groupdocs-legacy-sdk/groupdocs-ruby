class JobInfo
  ...
  def initialize(attributes = {})
    ...
    if attributes.to_s != ""
      ...
      if JobInfo.attribute_map["id".to_sym] != nil
        name = "id".to_sym
        value = attributes["id"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["out_formats".to_sym] != nil
      ...
      if JobInfo.attribute_map["actions".to_sym] != nil
        name = "actions".to_sym
        value = attributes["actions"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["status".to_sym] != nil
        name = "status".to_sym
        value = attributes["status"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["email_results".to_sym] != nil
        name = "email_results".to_sym
        value = attributes["email_results"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["priority".to_sym] != nil
        name = "priority".to_sym
        value = attributes["priority"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["url_only".to_sym] != nil
        name = "url_only".to_sym
        value = attributes["url_only"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["documents".to_sym] != nil
        name = "documents".to_sym
        value = attributes["documents"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["requested_time".to_sym] != nil
        name = "requested_time".to_sym
        value = attributes["requested_time"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["scheduled_time".to_sym] != nil
        name = "scheduled_time".to_sym
        value = attributes["scheduled_time"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["guid".to_sym] != nil
        name = "guid".to_sym
        value = attributes["guid"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["name".to_sym] != nil
        name = "name".to_sym
        value = attributes["name"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if JobInfo.attribute_map["callback_url".to_sym] != nil
  ...
  def to_body
    body = {}
    JobInfo.attribute_map.each_pair do |key,value|
