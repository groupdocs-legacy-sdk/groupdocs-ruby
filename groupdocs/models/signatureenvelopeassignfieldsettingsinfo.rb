class SignatureEnvelopeAssignFieldSettingsInfo
  ...
  def initialize(attributes = {})
    ...
    if attributes.to_s != ""
      ...
      if SignatureEnvelopeAssignFieldSettingsInfo.attribute_map["current_recipient_id".to_sym] != nil
        name = "current_recipient_id".to_sym
        value = attributes["currentRecipientId"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if SignatureEnvelopeAssignFieldSettingsInfo.attribute_map["new_recipient_id".to_sym] != nil
  ...
  def to_body
    body = {}
    SignatureEnvelopeAssignFieldSettingsInfo.attribute_map.each_pair do |key,value|
