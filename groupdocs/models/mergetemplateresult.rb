class MergeTemplateResult
  ...
  def initialize(attributes = {})
    ...
    if attributes.to_s != ""
      ...
      if MergeTemplateResult.attribute_map["job_id".to_sym] != nil
        name = "job_id".to_sym
        value = attributes["job_id"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if MergeTemplateResult.attribute_map["document_id".to_sym] != nil
        name = "document_id".to_sym
        value = attributes["document_id"]
        send("#{name}=", value) if self.respond_to?(name)
	      end
      if MergeTemplateResult.attribute_map["datasource_id".to_sym] != nil
  ...
  def to_body
    body = {}
    MergeTemplateResult.attribute_map.each_pair do |key,value|
